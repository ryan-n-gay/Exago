...
class Atframework_Video extends WP_Widget {
    ...
    public function __construct() {
		$widget_ops = array('classname' => 'atframework_video_widget', 'description' => __( 'Display a video from Youtube, Vimeo etc.', 'exago') );
        parent::__construct(false, $name = __('exago: Video', 'exago'), $widget_ops);
	...
	<p><label for="<?php echo $this->get_field_id( 'url' ); ?>"><?php _e( 'Paste the URL of the video (only from a network that supports oEmbed, like Youtube, Vimeo etc.):', 'exago' ); ?></label>
